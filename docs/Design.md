...
- Lexer: generated by non terminal symbols -> regex map
  - map: generated by non terminal symbols -> regex
    - non terminal symbols: generated by symbol table
      - symbol table: defined by user
    - regex: defined by user
- Parser: generated by parse table + semantic actions
  - parse table: generated by grammar + reduce on + priority of
    - grammar: generated by symbol -> symbol map + action
      - symbol: generated by symbol table
        - symbol table: defined by user
      - map: defined by user
      - action: defined by user
    - reduce on: defined by user
    - priority of: defined by user
  - semantic actions: defined by user

Defined by user (trait) (traits module):
...
Generated by compiler compiler (data struct) (core module):

1. symbol table
2. non terminal symbols - regex map
3. grammar

Generated by generator (data struct) (generator module):

1. non terminal symbols - regex map -> lexer's DFA table
2. grammar + priority of + reduce on -> parser's parse table

Compiler module:

1. lexer's DFA table -> lexer
2. parser's parse table -> parser
3. processor
